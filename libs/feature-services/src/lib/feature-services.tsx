...
//   return (
//     <div>
//       <h1>Welcome to FeatureServices!</h1>
//
//
//       {!services ?<pre>{JSON.stringify(services, null, 2)}</pre>
//         :
//       <ul>
//         {services.map((service, index) => (<li key={service.id}><b>{service.serviceName}</b></li>))}
//       </ul>
//       }
//
//     </div>
        ...
        {!services ? (
          ...
          services.map((service, index) => (
            ...
            <Avatar className="h-9 w-9">
              ...
              <AvatarFallback>{service.serviceName?.substring(0,1)}</AvatarFallback>
            </Avatar>
